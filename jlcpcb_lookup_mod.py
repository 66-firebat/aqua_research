...
def search_components(query: str, **kwargs: Any) -> list[dict]:
    """
    ...
    Args:
        ...
        **kwargs: Additional search parameters (e.g. package="SOIC-8", stock=100)

    Returns:
      List of component dicts with lcsc, mfr, package, description, stock, price.

    Example usage:
        search_components("STM32", package="SOIC-28", limit=5)
        search_components("capacitor", capacitance="100nF", package="0402")
    """
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("1. Searching for 5007 components")
    print("=" * 60)
    results = search_components("5007")
